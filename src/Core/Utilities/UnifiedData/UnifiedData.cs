...
namespace System.Data.HashFunction.Utilities.UnifiedData {
    ...
    public abstract class UnifiedData {
        ...
        /// </summary>
        /// <remarks>Implementors are not required to use this value.</remarks>
        ...
        /// <summary>
        /// Executes an action one or more times, providing the data read as an array whose length is
        /// a multiple of groupSize. Optionally runs an action on the final remainder group.
        /// </summary>
        ...
        /// <param name="remainderAction">
        /// Action to execute if the final group is less than groupSize. Null values are allowed.
        /// </param>
        /// <remarks>
        /// remainderAction will not be run if the length of the data is a multiple of groupSize.
        /// </remarks>
