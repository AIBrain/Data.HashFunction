...
namespace System.Data.HashFunction.Utilities.IntegerManipulation {
    ...
    internal static class ReverseByteOrderExtensions {
        ...
        /// <returns>Resulting 16-bit integer after reversing the operand's byte order.</returns>
#if !NET40
        ...
        /// <returns>Resulting 32-bit integer after reversing the parameter's byte order.</returns>
#if !NET40
        ...
        /// <returns>Resulting 64-bit integer after reversing the parameter's byte order.</returns>
#if !NET40
