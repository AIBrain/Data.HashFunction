...
namespace System.Data.HashFunction {
    ...
    ///
    /// This hash function has been superseded by <see cref="SpookyHashV2"/> due to a loss of entropy
    /// from a coding error in the original specification. It still passes the hash function tests
    /// the creator set for it, but it is preferred that SpookyHash V2 is used.
    /// </summary>
...
#endif
    {
        ...
        /// </summary>
        /// <value>The first seed value for hash calculation.</value>
        public UInt64 InitVal1 { get { return _InitVal1; } }

        /// <summary>
        /// Second seed value for hash calculation.
        /// </summary>
        /// <value>The second seed value for hash calculation.</value>
        /// <remarks>Not used for 32-bit and 64-bit modes, used as second seed for 128-bit mode.</remarks>
        ...
        /// <remarks>Defaults <see cref="InitVal1"/> to 0. <inheritdoc cref="SpookyHashV1(UInt64)"/></remarks>
        /// <inheritdoc cref="SpookyHashV1(UInt64)"/>
        public SpookyHashV1()
            : this( 0U ) {
        }

        /// <remarks>Defaults <see cref="InitVal1"/> to 0. <inheritdoc cref="SpookyHashV1(int, UInt64)"/></remarks>
        /// <inheritdoc cref="SpookyHashV1(int, UInt64)"/>
        public SpookyHashV1( Int32 hashSize )
            : this( hashSize, 0U ) {
        }

        /// <remarks>Defaults <see cref="InitVal2"/> to 0. <inheritdoc cref="SpookyHashV1(UInt64, UInt64)"/></remarks>
        /// <inheritdoc cref="SpookyHashV1(UInt64, UInt64)"/>
        public SpookyHashV1( UInt64 initVal1 )
            : this( initVal1, 0U ) {
        }

        /// <remarks>Defaults <see cref="HashFunctionBase.HashSize"/> to 128.</remarks>
        ...
        /// <remarks>Defaults <see cref="InitVal2"/> to 0.</remarks>
        /// <inheritdoc cref="SpookyHashV1(int, UInt64, UInt64)"/>
        ...
        /// hashSize;hashSize must be contained within SpookyHashV1.ValidHashSizes.
        /// </exception>
        /// <inheritdoc cref="HashFunctionBase(int)"/>
        public SpookyHashV1( Int32 hashSize, UInt64 initVal1, UInt64 initVal2 )
            : base( hashSize ) {
            if ( !ValidHashSizes.Contains( hashSize ) ) {
                throw new ArgumentOutOfRangeException( nameof(hashSize), "hashSize must be contained within SpookyHashV1.ValidHashSizes." );
            }
