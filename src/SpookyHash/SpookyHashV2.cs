...
namespace System.Data.HashFunction {
...
#endif
    {
        ...
        /// <remarks>Defaults <see cref="InitVal1"/> to 0. <inheritdoc cref="SpookyHashV2(UInt64)"/></remarks>
        /// <inheritdoc cref="SpookyHashV2(UInt64)"/>
        public SpookyHashV2()
            : this( 0U ) {
        }

        /// <remarks>Defaults <see cref="InitVal1"/> to 0. <inheritdoc cref="SpookyHashV2(int, UInt64)"/></remarks>
        /// <inheritdoc cref="SpookyHashV2(int, UInt64)"/>
        public SpookyHashV2( Int32 hashSize )
            : this( hashSize, 0U ) {
        }

        /// <remarks>Defaults <see cref="InitVal2"/> to 0. <inheritdoc cref="SpookyHashV2(UInt64, UInt64)"/></remarks>
        ...
        /// <inheritdoc cref="SpookyHashV2(int, UInt64, UInt64)"/>
        public SpookyHashV2( Int32 hashSize, UInt64 initVal1 )
