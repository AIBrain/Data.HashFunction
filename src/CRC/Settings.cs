...
namespace System.Data.HashFunction {
    ...
    public partial class CRC {
        ...
        public class Setting {
            ...
            /// </summary>
            /// <value>The length of the produced CRC value, in bits</value>
            public Int32 Bits { get; private set; }

            /// <summary>
            /// Divisor to use when calculating the CRC.
            /// </summary>
            /// <value>The divisor that will be used when calculating the CRC value.</value>
            ...
            /// </summary>
            /// <value>
            /// The value that will be used to initialize the CRC register before the calculation of
            /// the CRC value.
            /// </value>
            ...
            /// </summary>
            /// <value>
            /// <c>true</c> if the CRC calculation processes the output as big endian bit order;
            /// otherwise, <c>false</c>.
            /// </value>
            ...
            /// </summary>
            /// <value>The value to xor with the final CRC value.</value>
            ...
            /// bits;bitLength must be in the range [1, 64].
            /// </exception>
            public Setting(
            ...
            /// <summary>
            /// Ensures that the 64-bit inputValue is not greater than the maximum unsigned value for
            /// a [bitLength]-length integer.
            /// </summary>
            /// <param name="paramName"> 
            /// Name of the parameter being passed, used in exception that is thrown if the value is invalid.
            /// </param>
