...
namespace System.Data.HashFunction {
    ...
    /// http://en.wikipedia.org/wiki/Cyclic_redundancy_check. This implementation is generalized to
    /// encompass all possible CRC parameters from 1 to 64 bits.
    /// </summary>
...
#endif
    {
        ...
        /// </summary>
        /// <value>The CRC parameters that will be used to calculate hash values.</value>
        ...
        /// </summary>
        /// <value>
        /// The current CRC parameters that will be used when a new <see cref="CRC"/> instance is
        /// created via its default constructor.
        /// </value>
        /// <exception cref="System.ArgumentNullException">value</exception>
        /// <remarks>Defaults to the settings for <see cref="CRCStandards.CRC32"/>.</remarks>
        ...
        /// <returns>
        /// Array of UInt64 values that allows a CRC implementation to look up the result of dividing
        /// the index (data) by the polynomial.
        /// </returns>
        /// <remarks>
        /// Resulting array contains 256 items if settings.Bits &gt;= 8, or 2 items if settings.Bits
        /// &lt; 8. The table accounts for reflecting the index bits to fix the input endianness, but
        /// it is not possible completely account for the output endianness if the CRC is mixed-endianness.
        /// </remarks>
