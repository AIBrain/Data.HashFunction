...
namespace System.Data.HashFunction {
...
#endif
    {
        ...
        /// <remarks>Only seed value for 32-bit mode, first seed value for 64-bit mode.</remarks>
        ...
        /// <remarks>Not used for 32-bit mode, second seed value for 64-bit mode.</remarks>
        ...
        /// <remarks>Defaults <see cref="InitVal1"/> to 0. <inheritdoc cref="JenkinsLookup3(UInt32)"/></remarks>
        /// <inheritdoc cref="JenkinsLookup3(UInt32)"/>
        public JenkinsLookup3()
            : this( 0U ) {
        }

        /// <remarks>Defaults <see cref="InitVal2"/> to 0. <inheritdoc cref="JenkinsLookup3(UInt32, UInt32)"/></remarks>
        /// <inheritdoc cref="JenkinsLookup3(UInt32, UInt32)"/>
        public JenkinsLookup3( UInt32 initVal1 )
            : this( initVal1, 0U ) {
        }

        /// <remarks>Defaults <see cref="HashFunctionBase.HashSize"/> to 32.</remarks>
        ...
        /// <remarks>Defaults <see cref="InitVal1"/> to 0. <inheritdoc cref="JenkinsLookup3(int, UInt32)"/></remarks>
        /// <inheritdoc cref="JenkinsLookup3(int, UInt32)"/>
        public JenkinsLookup3( Int32 hashSize )
            : this( hashSize, 0U ) {
        }

        /// <remarks>Defaults <see cref="InitVal2"/> to 0.</remarks>
        /// <inheritdoc cref="JenkinsLookup3(int, UInt32, UInt32)"/>
        public JenkinsLookup3( Int32 hashSize, UInt32 initVal1 )
        ...
        /// hashSize;hashSize must be contained within SpookyHashV2.ValidHashSizes.
        /// </exception>
