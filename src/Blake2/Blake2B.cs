...
namespace System.Data.HashFunction {
    ...
    /// <summary>
    /// Implementation of BLAKE2b as specified at https://blake2.net/. Modified from the canonical C#
    /// port at https://blake2.net/blake2_code_20140114.zip. Supports a hash output size of 8 through
    /// 512 bits in 8-bit increments and allows seeding with a key, salt, and/or personalization sequence.
    /// </summary>
...
#endif
    {
        ...
        /// <summary>
        /// Initializes an instance of the <see cref="Blake2B"/> class with the default settings (no
        /// key, no salt, no personalization, and 512 output length).
        /// </summary>
        public Blake2B()
        ...
        ///
        /// The <paramref name="hashSize"/> must be 8 bits at the least and 512 bits at most, and the
        /// size in bits must be a multiple of 8.
        /// </summary>
        ...
        /// <summary>
        /// Initializes an instance of the <see cref="Blake2B"/> class with the default hash size. If
        /// not null, the <paramref name="key"/>, <paramref name="salt"/>, and
        /// <paramref name="personalization"/> arguments will be applied to the hashing algorithm.
        ///
        /// The <paramref name="key"/> parameter must be a byte sequence of at most 64 bytes. The
        /// <paramref name="salt"/> parameter must be a byte sequence of exactly 16 bytes. The
        /// <paramref name="personalization"/> parameter must be a byte sequence of exactly 16 bytes.
        /// </summary>
        ...
        /// <exception cref="ArgumentOutOfRangeException">
        /// Either the provided <paramref name="key"/> length, <paramref name="salt"/> length, or
        /// <paramref name="personalization"/> length is invalid.
        /// </exception>
        ...
        /// <paramref name="salt"/>, and <paramref name="personalization"/> arguments will be applied
        /// to the hashing algorithm.
        ///
        /// The <paramref name="hashSize"/> must be 8 bits at the least and 512 bits at most, and the
        /// size in bits must be a multiple of 8. The <paramref name="key"/> parameter must be a byte
        /// sequence of at most 64 bytes. The <paramref name="salt"/> parameter must be a byte
        /// sequence of exactly 16 bytes. The <paramref name="personalization"/> parameter must be a
